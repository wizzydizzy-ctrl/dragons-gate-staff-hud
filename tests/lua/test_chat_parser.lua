...
test("parses private mental and staff channels",function()
  ...
  eq(thought.category,"ESP"); eq(thought.speaker,"Seaux"); eq(thought.target,nil); eq(thought.message,"Hello")
  local named=assert(Parser.parse('\27[35mAeron Del\'mar thinks to you, "Testing."\27[0m',"Dace Alterac"))
  eq(named.category,"ESP"); eq(named.speaker,"Aeron Del'mar"); eq(named.message,"Testing.")
