...
test("color options menu exposes current and future feature toggles",function()
  ...
  view:setColorOptions({enabled=true,room=true,exits=false,currency=true,portal=true,attack=true,damage=true,danger=true,recovery=true,upkeep=true,spell=true,discovery=true,illumination=true})
