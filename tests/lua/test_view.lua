...
test("autoroller settings modal validates through one save callback and remains bounded",function()
  ...
  view.roller_fields.target_total.input.text="60"; assert(view:saveRollerSettings()); eq(received.target_total,"60"); eq(received.arrange_mode,"minimums"); eq(received.minimum_greats,"2"); eq(received.minimum_good_plus,"5"); eq(received.min_stats.APP,"5"); eq(received.min_stats.MP,"5"); eq(view.roller_settings_visible,false)
end)
...
test("help overlay distinguishes commands descriptions and warnings",function()
  ...
  eq(view.help_content.message:find("both 12-characteristic rolling methods",1,true)~=nil,true)
