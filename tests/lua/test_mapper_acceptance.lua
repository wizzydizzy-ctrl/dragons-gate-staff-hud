...
test("HUD release defaults are ready for version 0.2.164",function()
  eq(Defaults.version,"0.2.164"); eq(Defaults.mapper.enabled,true); eq(Defaults.mapper.walk_timeout,12)
