...
test("HUD release defaults are ready for version 0.3.25",function()
  eq(Defaults.version,"0.3.25"); eq(Defaults.view_schema,2); eq(Defaults.mapper.enabled,true); eq(Defaults.mapper.walk_timeout,12)
