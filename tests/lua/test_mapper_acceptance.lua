...
test("HUD release defaults are ready for version 0.3.49",function()
  eq(Defaults.version,"0.3.49"); eq(Defaults.view_schema,4); eq(Defaults.mapper.enabled,true); eq(Defaults.mapper.walk_timeout,12)
