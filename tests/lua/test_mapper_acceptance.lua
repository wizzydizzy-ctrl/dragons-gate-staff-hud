...
test("HUD release defaults are ready for version 0.3.26",function()
  eq(Defaults.version,"0.3.26"); eq(Defaults.view_schema,2); eq(Defaults.mapper.enabled,true); eq(Defaults.mapper.walk_timeout,12)
