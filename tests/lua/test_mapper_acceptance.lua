...
test("HUD release defaults are ready for version 0.3.28",function()
  eq(Defaults.version,"0.3.28"); eq(Defaults.view_schema,2); eq(Defaults.mapper.enabled,true); eq(Defaults.mapper.walk_timeout,12)
