...
test("HUD release defaults are ready for version 0.2.160",function()
  eq(Defaults.version,"0.2.160"); eq(Defaults.mapper.enabled,true); eq(Defaults.mapper.walk_timeout,12)
