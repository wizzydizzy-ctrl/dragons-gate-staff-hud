...
test("HUD release defaults are ready for version 0.3.32",function()
  eq(Defaults.version,"0.3.32"); eq(Defaults.view_schema,3); eq(Defaults.mapper.enabled,true); eq(Defaults.mapper.walk_timeout,12)
