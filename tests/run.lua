...
dofile(root .. "/tests/lua/test_chat_sounds.lua")
dofile(root .. "/tests/lua/test_output_colorizer.lua")
dofile(root .. "/tests/lua/test_color_styles.lua")
dofile(root .. "/tests/lua/test_color_preferences.lua")
dofile(root .. "/tests/lua/test_travel_highlights.lua")
dofile(root .. "/tests/lua/test_posture_tracker.lua")
dofile(root .. "/tests/lua/test_needs_tracker.lua")
