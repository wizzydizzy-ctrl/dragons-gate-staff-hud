...
function View:renderMapSettings(populate)
  ...
  self.map_settings_status:echo(View.withFont(self.map_settings_error and ("<span style='color:"..t.hp.."'><b>"..safeText(self.map_settings_error).."</b></span>") or safeText(self.map_settings_status_text or "Solid: directions. Dotted: special exits."),font)); return true
end
